...
function Footer() {
  let css =
    'transition ease-in-out border-b border-cl2 hover:border-cl3 hover:text-cl3 font-gabriela'
  return (
    <div className="sticky z-10 top-0 px-4 py-3 bg-cl1 text-cl2 w-screen flex justify-center rounded-t-xl">
      <div className="hidden sm:flex text-center font-normal w-full h-full text-base items-center justify-center">
        ...
        <div className="px-6" />
        <div className={css}>
          <Link href="/gesetzliches/datenschutz">Datenschutz</Link>
        </div>
        <div className="px-6" />
        <div className={css}>
          <Link href="/gesetzliches/impressum">Impressum</Link>
        </div>
      </div>
