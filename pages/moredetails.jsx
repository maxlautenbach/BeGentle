        ...
        >
          ...
          <div className="text-left w-screen p-8">
            ...
            <ul className="list-disc m-4 text-xs">
              ...
              <li>
                gebaut von Ryszard Osowski in feinster Handarbeit in
                Oberfranken, Deutschland
              </li>
              <li>
                ausgesuchte langjährig abgelagerte Tonhölzer aus den besten
                Regionen Bayerns, Österreichs, der Schweiz und Bosniens
              </li>
              <li>
                selektierte feinjährige Fichtendecke und Korpus aus
                tiefgeflammten Riegelahorn
              </li>
              <li>
                goldbraune Handlackierung aus Naturharzen nach eigener Rezeptur
              </li>
              ...
              <li>
                tragender Klang mit starker Projektion, edle Palisander-Montur,
                Thomastik Infeld Rondo Besaitung
              </li>
              <li>
                Ebenholzgriffbrett, Feinstimmer für die E-Saite, Aubert Steg
